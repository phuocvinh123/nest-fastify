    ...
    async run(dataSource, factoryManager) {
        const dataRoleSuperAdmin = {
            ...
            permissions: [
                ...
                _service_1.PRODUCT_CREATE,
                _service_1.PRODUCT_LIST,
                _service_1.PRODUCT_DETAIL,
                _service_1.PRODUCT_UPDATE,
                _service_1.PRODUCT_DELETE,
                _service_1.CATEGORY_CREATE,
                _service_1.CATEGORY_UPDATE,
                _service_1.CATEGORY_DETAIL,
                _service_1.CATEGORY_LIST,
                _service_1.CATEGORY_DELETE,
                _service_1.STORE_LISTED,
                _service_1.STORE_DETAIL,
                _service_1.STORE_CREATE,
                _service_1.STORE_UPDATE,
                _service_1.STORE_DELETE,
                _service_1.P_ORDER_LISTED,
                _service_1.P_ORDER_CREATE,
            ],
            isSystemAdmin: false,
        };
