...
let CodeType = class CodeType extends _shared_1.Base {
};
...
], CodeType.prototype, "name", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    ...
    __metadata("design:type", String)
], CodeType.prototype, "code", void 0);
__decorate([
    (0, typeorm_1.Column)({ default: false }),
    (0, swagger_1.ApiProperty)({ example: false, description: '' }),
    (0, class_validator_1.IsBoolean)(),
    __metadata("design:type", Boolean)
], CodeType.prototype, "isPrimary", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => _model_1.Code, (category) => category.item, { eager: true, onDelete: 'CASCADE', onUpdate: 'CASCADE' }),
    (0, class_transformer_1.Expose)({ groups: [_shared_1.MaxGroup] }),
    __metadata("design:type", Array)
], CodeType.prototype, "items", void 0);
exports.CodeType = CodeType = __decorate([
    (0, typeorm_1.Entity)({ schema: 'core' }),
    (0, typeorm_1.Unique)(['code'])
], CodeType);
//# sourceMappingURL=code-type.model.js.map