...
__decorate([
    (0, _shared_1.Auth)({
        ...
        permission: _service_1.P_PARAMETER_LISTED,
    }),
    (0, common_1.Get)(''),
    openapi.ApiResponse({ status: 200, type: require("../dto/parameter.dto").ListParameterResponseDto }),
...
__decorate([
    ...
    (0, common_1.Get)(':code'),
    openapi.ApiResponse({ status: 200, type: require("../dto/parameter.dto").ParameterResponseDto }),
    __param(0, (0, nestjs_i18n_1.I18n)()),
...
__decorate([
    (0, _shared_1.Auth)({
        summary: 'Create data',
        permission: _service_1.P_PARAMETER_CREATE,
    }),
    (0, common_1.Post)(''),
    openapi.ApiResponse({ status: 201, type: require("../dto/parameter.dto").ParameterResponseDto }),
    __param(0, (0, nestjs_i18n_1.I18n)()),
    __param(1, (0, common_1.Body)(new _shared_1.SerializerBody())),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [nestjs_i18n_1.I18nContext,
        _dto_1.CreateParameterRequestDto]),
    __metadata("design:returntype", Promise)
], ParameterController.prototype, "create", null);
__decorate([
    (0, _shared_1.Auth)({
        summary: 'Update data',
        permission: _service_1.P_PARAMETER_UPDATE,
    }),
    (0, common_1.Put)(':id'),
    openapi.ApiResponse({ status: 200, type: require("../dto/parameter.dto").ParameterResponseDto }),
    __param(0, (0, nestjs_i18n_1.I18n)()),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [nestjs_i18n_1.I18nContext, String, _dto_1.UpdateParameterRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ParameterController.prototype, "updateDisable", null);
__decorate([
    (0, _shared_1.Auth)({
        summary: 'Delete data',
        permission: _service_1.P_PARAMETER_DELETE,
    }),
...
exports.ParameterController = ParameterController = __decorate([
    (0, _shared_1.Headers)('parameter'),
    __metadata("design:paramtypes", [_service_1.ParameterService])
], ParameterController);
