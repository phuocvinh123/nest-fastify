...
__decorate([
    (0, _shared_1.Auth)({
        ...
        permission: _service_1.P_DATA_LISTED,
        serializeOptions: { groups: [] },
    }),
    (0, common_1.Get)(''),
    openapi.ApiResponse({ status: 200, type: require("../dto/data.dto").ListDataResponseDto }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 200, type: require("../dto/data.dto").ArrayDataResponseDto }),
    __param(0, (0, nestjs_i18n_1.I18n)()),
    __param(1, (0, common_1.Query)(new common_1.ValidationPipe({ transform: true }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [nestjs_i18n_1.I18nContext,
        _shared_1.PaginationQueryDto]),
    __metadata("design:returntype", Promise)
], DataController.prototype, "findOneByArray", null);
__decorate([
    (0, _shared_1.Public)({
    ...
    (0, common_1.Get)(':id'),
    openapi.ApiResponse({ status: 200, type: require("../dto/data.dto").DataResponseDto }),
    __param(0, (0, nestjs_i18n_1.I18n)()),
...
__decorate([
    (0, _shared_1.Auth)({
        summary: 'Create data',
        permission: _service_1.P_DATA_CREATE,
    }),
    (0, common_1.Post)(''),
    openapi.ApiResponse({ status: 201, type: require("../dto/data.dto").DataResponseDto }),
    __param(0, (0, nestjs_i18n_1.I18n)()),
    __param(1, (0, common_1.Body)(new _shared_1.SerializerBody([_shared_1.MaxGroup]))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [nestjs_i18n_1.I18nContext,
        _dto_1.CreateDataRequestDto]),
    __metadata("design:returntype", Promise)
], DataController.prototype, "create", null);
__decorate([
    (0, _shared_1.Auth)({
        summary: 'Update data',
        permission: _service_1.P_DATA_UPDATE,
    }),
    (0, common_1.Put)(':id'),
    openapi.ApiResponse({ status: 200, type: require("../dto/data.dto").DataResponseDto }),
    __param(0, (0, nestjs_i18n_1.I18n)()),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [nestjs_i18n_1.I18nContext, String, _dto_1.UpdateDataRequestDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DataController.prototype, "updateDisable", null);
__decorate([
    (0, _shared_1.Auth)({
        summary: 'Delete data',
        permission: _service_1.P_DATA_DELETE,
    }),
...
exports.DataController = DataController = __decorate([
    (0, _shared_1.Headers)('data'),
    __metadata("design:paramtypes", [_service_1.DataService])
], DataController);
